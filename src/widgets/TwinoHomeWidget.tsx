...
import type { TwinoHomeWidgetPayload } from "./widget-types";
...
const TwinoHomeWidgetView = (
  props: TwinoHomeWidgetPayload,
...
export const TwinoHomeWidget = createWidget("TwinoHome", TwinoHomeWidgetView);
export default TwinoHomeWidget;
