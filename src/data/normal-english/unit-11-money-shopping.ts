...
const unit11: UnitBank = [
    ...
    ],
    {
      ...
      fills: [
        fill(
          ...
          {
            sentence: "هذا الحذاء متوفر ___ تسعة؟",
            answer: "بقياس",
            wrongs: ["بلون", "بسعر", "بشكل"],
          },
        ...
        fill(
          ...
          {
            sentence: "بصراحة، أحس السعر شوية ___.",
            answer: "غالي",
            wrongs: ["رخيص", "حلو", "طويل"],
          },
      ...
      convos: [
        {
          ...
          theyAskAr: "أكدر أساعدك تدور على شي اليوم؟",
    ...
    ],
    {
      ...
      fills: [
        fill(
          ...
          {
            sentence: "بعده عالـ ___ ، فالتصليح ببلاش.",
            answer: "ضمان",
            wrongs: ["شحن", "وعد", "عقد"],
          },
        ...
        fill(
          ...
          {
            sentence: "المفروض تطلع الفلوس خلال تلاث أيام ___.",
            answer: "عمل",
            wrongs: ["عطلة", "سفر", "نوم"],
          },
      ...
      convos: [
        {
          ...
          theyAskAr: "شنو المشكلة بالمنتج اللي اشتريته؟",
          ...
          correctAr: "أريد أرجع هذا المنتج — القياس مو مناسب. وعندي الوصل من الثلاثاء الفاتت.",
        ...
        },
        {
          ...
          theyAskAr: "الباكيت جان مفتوح من وصلك؟",
          ...
          correctAr: "إي — المنتج وصل مكسور بالكرتونة. أكدر أرجع الفلوس لنفس البطاقة؟",
    ...
    ],
    {
      ...
      fills: [
        fill(
          ...
          {
            sentence: "أحتاج ___ صك بميتين دولار.",
            answer: "أودع",
            wrongs: ["أصرف", "أستلف", "أشگ"],
          },
        ...
        fill(
          ...
          {
            sentence: "حسابي ___ ثمانين دولار ليوم الجمعة.",
            answer: "ناقص",
            wrongs: ["زايد", "قريب", "فارغ"],
          },
      ...
      convos: [
        {
          ...
          theyAskAr: "شلون أساعدك بمعاملاتك المصرفية اليوم؟",
          ...
          correctAr: "أريد أفتح حساب جاري. شكد أقل رصيد مطلوب؟ وهمين أكدر أسوي إيداع مباشر للراتب؟",
        ...
        },
        {
          ...
          theyAskAr: "سويت مشترى بمبلغ جبير هالأيام؟",
          ...
          correctAr: "إي — بطاقتي انرفضت بالمحل. أحتاج أحول فلوس لحساب ثاني أو أرفع الحد مال البطاقة.",
    ...
    ],
    {
      ...
      fills: [
        fill(
          ...
          {
            sentence: "لازم ___ الإيجار أول يوم بالشهر.",
            answer: "يندفع",
            wrongs: ["يطير", "يخلص", "ينزل"],
          },
        ...
        fill(
          ...
          {
            sentence: "ترجعلي فلوس ___ إذا عفت المكان نظيف.",
            answer: "التأمين",
            wrongs: ["الإيجار", "الأكل", "السيارة"],
          },
      ...
      convos: [
        {
          ...
          theyAskAr: "هاي الشقة بألف وميتين دولار بالشهر — مهتم بيها؟",
          ...
          correctAr: "شوكت لازم يندفع الإيجار كل شهر؟ وهمين فواتير الخدمات مشمولة لو معزولة؟",
        ...
        },
        {
          ...
          correctAr: "أكو خرير بسكف الحمام — بدى ورا المطرة الأخيرة. يكدر أحد يجي يصلحه عن قريب؟",
    ...
    ],
    {
      ...
      fills: [
        fill(
          ...
          {
            sentence: "خل ___ على تلاثة وبس.",
            answer: "نقسمها",
            wrongs: ["نبيعها", "نشتريها", "نطبخها"],
          },
        ...
        fill(
          ...
          {
            sentence: "بالعادة أخلي ___ حوالي عشرين بالمية.",
            answer: "بخشيش",
            wrongs: ["أكل", "شاي", "عشا"],
          },
    ...
    ],
    {
      ...
      fills: [
        fill(
          ...
          "بيا ممر المعكرونة؟",
          {
            sentence: "بيا ___ المعكرونة؟",
            answer: "ممر",
            wrongs: ["محل", "شارع", "كراج"],
          },
        ...
        fill(
          ...
          {
            sentence: "هذا الكوبون ___ باجر، فخل نستعمله اليوم.",
            answer: "يخلص",
            wrongs: ["يبدي", "ينزل", "يصعد"],
          },
      ...
      convos: [
        {
          ...
          theyAskAr: "المجموع ٤٣ دولار و١٨ سنت. كاش لو بطاقة؟",
          ...
          correctAr: "بالبطاقة فدوة — بس أتصور هذا انحسب بسعر غلط. السعر اللي عالرف جان ٣ دولارات و٤٩ سنت.",
        ...
        },
        {
          ...
          explanationRu: "В США мясную нарезку в отделе гастрономии часто заказывают в фунтах; просьба нарезать тонко помогает получить нужную толщину."
        },
      ],
    },
    "المسواك",
  ...
  buildLesson(
    ...
    {
      speakPhrases: [
        { en: "Does the cheaper tier still let me stream in HD?", ku: "پلانە هەرزانەکە هێشتا ڕێگەم دەدات بە HD تەماشا بکەم؟", ar: "الخطة الأرخص تخليني أشوف بجودة عالية؟", ru: "Позволяет ли более дешевый тариф смотреть в высоком качестве?" },
      ...
      fills: [
        fill(
          ...
          {
            sentence: "التجربة المجانية تتجدد ___ إذا ما لغيتها.",
            answer: "تلقائياً",
            wrongs: ["يدوياً", "صعباً", "بعيداً"],
          },
        ...
        fill(
          ...
          {
            sentence: "يطلع أرخص على المدى ___ إذا دفعت سنوي.",
            answer: "الطويل",
            wrongs: ["القصير", "السريع", "القريب"],
          },
      ...
      convos: [
        {
          ...
          theyAskAr: "تحب تبدأ فترة التجربة المجانية لمدة ١٤ يوم؟",
          ...
          correctAr: "يجوز. شوکت تتحول لخطة بفلوس، وأكدر ألغي بأي وقت بدون غرامة؟",
        ...
        },
        {
          ...
          theyAskAr: "خطة بريميوم أغلى بـ ١٢ دولار بالشهر. تريدها؟",
          ...
          correctAr: "شنو تشمل هاي الـ ١٢ دولار الزيادة؟ أريد تفصيل نقطة بنقطة قبل لا أقرر.",
    ...
    ],
    {
      ...
      fills: [
        fill(
          ...
          {
            sentence: "أكو ___ خمسة وعشرين دولار ما أعرفه.",
            answer: "مبلغ",
            wrongs: ["تليفون", "نت", "رقم"],
          },
        ...
        fill(
          ...
          {
            sentence: "تكدر ___ هاي الأجور من حسابي؟",
            answer: "تشيل",
            wrongs: ["تزيد", "تدفع", "تكتب"],
          },
      ...
      convos: [
        {
          ...
          theyAskAr: "دا أشوف القائمة. شنو تحب أراجعلك بيها؟",
          ...
          correctAr: "القائمة أعلى من الشهر الراح. تكدر توضحلي الرسوم الإضافية مال ٢٥ دولار بالسطر الرابع؟",
        ...
        },
        {
          ...
          theyAskAr: "شلت الترقية ونزلتلك رصيد بحسابك. محتاج شي ثاني؟",
          ...
          correctAr: "شكراً. شوكت ينزل الرصيد بالحساب، وتكدر تدزلي تأكيد التغيير بالإيميل؟",
          ...
          explanationRu: "Письменное подтверждение защитит вас, если ошибка повторится в следующем счете."
        },
      ],
    },
    ...
    ],
    {
      ...
      fills: [
        fill(
          ...
          {
            sentence: "الضريبة ___ قبل لا أشوف الفلوس أصلاً.",
            answer: "تنكص",
            wrongs: ["تزيد", "ترجع", "تطير"]
          },
        ...
        fill(
          ...
          {
            sentence: "لازم ___ تقريري الضريبي قبل خمسطعش نيسان.",
            answer: "أقدم",
            wrongs: ["أشگ", "أضيع", "أبيع"]
          },
      ...
      convos: [
        {
          ...
          theyAskAr: "شنو اللي مبين مو صحيح بوصل الراتب مالتك؟",
          ...
          correctAr: "طالع بي بس ٧٢ ساعة، بس آني مشتغل ٨٠ ساعة. يكدر قسم الرواتب يصحح الساعات بهذا الصك؟",
        ...
        },
        {
          ...
          theyAskAr: "راح تقدم التقرير الضريبي بنفسك هاي السنة؟",
          ...
          correctAr: "غالباً لا. أفضل شخص مختص يقدمه، ومحتاج نسخة من نموذج W-2 مال العام.",
    ...
    ],
    {
      ...
      fills: [
        fill(
          ...
          {
            sentence: "أريد ___ على هاي العملية.",
            answer: "أعترض",
            wrongs: ["أوافق", "أفرح", "أركض"]
          },
        ...
        fill(
          ...
          {
            sentence: "بلا زحمة ___ البطاقة حتى ما تصير أي عملية ثانية.",
            answer: "جمد",
            wrongs: ["شغل", "سجل", "احرك"]
          },
      ...
      convos: [
        {
          ...
          theyAskAr: "البطاقة الحقيقية بعدها يمك؟",
          ...
          correctAr: "إي، بعدها يمي، وما أعرف هاي العملية. بلا زحمة جمدوا البطاقة بين ما تحققون بالموضوع.",
        ...
        },
        {
          ...
          theyAskAr: "فتحنا طلب الاعتراض. محتاج أي شي ثاني؟",
          ...
          correctAr: "إي — شكد تاخذ الإجراءات بالعادي، وتكدر تدزلي رقم القضية برسالة؟",
