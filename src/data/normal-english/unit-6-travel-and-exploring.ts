...
const normalUnit05: UnitBank = [
  ...
  // Lesson 2: Navigating Public Transport
  {
    ...
    words: [
      ...
      { english: "Mind the gap",         kurdish: "ئاگاداری بۆشاییەکە بە (نێوان شەمەندەفەر و ڕێگاکە)", arabic: "انتبه للفجوة" },
  ...
  // Lesson 8: Eating at Street Food Stalls
  {
    ...
    words: [
      ...
      { english: "Food stall",           kurdish: "عەرەبانەی خواردن / دوکانی بچووک لە شەقام", arabic: "عربة طعام / كشك طعام" },
