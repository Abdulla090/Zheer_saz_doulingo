...
const normalUnit00: UnitBank = [
  ...
  // Lesson 1: Apologizing & Making Excuses
  {
    ...
    fillBlanks: [
      { parts: ["I should", "asked for help sooner."], hint: "دەبوایە زووتر داوای یارمەتیم بکردایە.", answer: "have", wrongs: ["of", "to", "been"], arabicHint: "جان لازم اطلب المساعدة من وكت.", arabicParts: ["جان لازم", "المساعدة من وكت."], arabicAnswer: "اطلب", arabicWrongs: ["اسأل", "اشوف", "ادور"], russianHint: "Мне стоило попросить о помощи раньше.", russianParts: ["Мне стоило", "о помощи раньше."], russianAnswer: "попросить", russianWrongs: ["подождать", "отказаться", "забыть"] },
  ...
  // Lesson 3: Asking for Clarification
  {
    ...
    fillBlanks: [
      { parts: ["Could you", "on that last point?"], hint: "دەتوانیت ئەو خاڵەی کۆتایی زیاتر ڕوون بکەیتەوە؟", answer: "elaborate", wrongs: ["explain", "expand", "repeat"], arabicHint: "تكدر تشرح اكثر عن النقطة الاخيرة؟", arabicParts: ["تكدر", "اكثر عن النقطة الاخيرة؟"], arabicAnswer: "تشرح", arabicWrongs: ["توضح", "تعيد", "تزيد"], russianHint: "Не мог бы ты остановиться на этом последнем пункте поподробнее?", russianParts: ["Не мог бы ты рассказать", "об этом последнем пункте?"], russianAnswer: "поподробнее", russianWrongs: ["объяснить", "расширить", "повторить"] },
      { parts: ["Just to", "— we meet at 3pm, right?"], hint: "تەنها بۆ دڵنیابوون — کاتژمێر ٣ کۆدەبینەوە، ڕاستە؟", answer: "confirm", wrongs: ["check", "verify", "know"], arabicHint: "بس حتى اتأكد — نلتقي بـ 3، مو؟", arabicParts: ["بس حتى", "— نلتقي بـ 3، مو؟"], arabicAnswer: "اتأكد", arabicWrongs: ["اشوف", "اعرف", "اسأل"], russianHint: "Просто чтобы убедиться — мы встречаемся в 3 часа, верно?", russianParts: ["Просто чтобы", "— мы встречаемся в 3 часа, верно?"], russianAnswer: "убедиться", russianWrongs: ["проверить", "узнать", "спросить"] },
    ],
    conversations: [
      { situation: "دوای پێشکەشکردنێک", theyAsk: "Any questions about what I just said?", correct: "Yes — could you clarify what you mean by 'flexible timeline'? If I understand correctly, the dates can change?", wrong1: "What does 'flexible timeline' mean?", wrong2: "I don't understand what you mean by a flexible timeline.", wrong3: "Can you explain the timeline?", explanation: "'Could you clarify... If I understand correctly' — باشترین ڕێگەن بۆ پرسیارکردن بەبێ ئەوەی بەرامبەر بێزار بکەیت", situationAr: "بعد تقديم", explanationAr: "'Could you clarify... If I understand correctly' — احسن الطرق تسأل بيها بدون ما تزعج المقابل", theyAskAr: "اكو اي سؤال على اللي كلته هسة؟", correctAr: "اي — تكدر توضح شتقصد بـ 'جدول مرن'؟ اذا فهمت صح، المواعيد تكدر تتغير؟", wrong1Ar: "شنو يعني 'جدول مرن'؟", wrong2Ar: "ما دا افتهم شتقصد بجدول مرن.", wrong3Ar: "تكدر تشرح الجدول؟", situationRu: "После презентации", theyAskRu: "Есть вопросы по тому, что я только что сказал?", correctRu: "Да — не мог бы ты пояснить, что имеешь в виду под «гибкими сроками»? Если я правильно понял, даты могут меняться?", wrong1Ru: "Что значит «гибкие сроки»?", wrong2Ru: "Я не понимаю, что ты имеешь в виду под гибкими сроками.", wrong3Ru: "Можешь объяснить сроки?", explanationRu: "'Could you clarify... If I understand correctly' — лучший способ задать вопрос, не раздражая собеседника" },
    ],
  },
  ...
  // Lesson 4: Talking About the Future
  {
    ...
    fillBlanks: [
      { parts: ["My", "is to become fluent in two years."], hint: "ئامانجم ئەوەیە کە لە ماوەی دوو ساڵدا پاراو بم لە زمانەکە.", answer: "goal", wrongs: ["plan", "hope", "dream"], arabicHint: "هدفي احجي بطلاقة خلال سنتين.", arabicParts: ["", "احجي بطلاقة خلال سنتين."], arabicAnswer: "هدفي", arabicWrongs: ["خطتي", "املي", "حلمي"], russianHint: "Моя цель — свободно заговорить через два года.", russianParts: ["Моя", "— свободно заговорить через два года."], russianAnswer: "цель", russianWrongs: ["план", "надежда", "мечта"] },
      { parts: ["I'm hoping", "finish this course by summer."], hint: "هیوادارم تا هاوین ئەم کۆرسە تەواو بکەم.", answer: "to", wrongs: ["for", "of", "about"], arabicHint: "اتمنى اخلص هالدورة قبل الصيف.", arabicParts: ["اتمنى", "هالدورة قبل الصيف."], arabicAnswer: "اخلص", arabicWrongs: ["ابدي", "اشوف", "ادخل"], russianHint: "Надеюсь закончить этот курс к лету.", russianParts: ["Надеюсь", "закончить этот курс к лету."], russianAnswer: "успеть", russianWrongs: ["забыть", "бросить", "отложить"] },
    ],
    conversations: [
      { situation: "چاوپێکەوتنی کار", theyAsk: "Where do you see yourself in five years?", correct: "In the long run, my goal is to lead a team. I'm planning to develop my leadership skills over the next two years.", wrong1: "I want to be a leader in 5 years.", wrong2: "My plan is to get promoted.", wrong3: "I hope to be successful in 5 years.", explanation: "'In the long run... I'm planning to' — وەڵامێکی زۆر گونجاو و پیشەییە بۆ ئەم پرسیارە", situationAr: "مقابلة شغل", explanationAr: "'In the long run... I'm planning to' — جواب كلش مناسب واحترافي لهالسؤال", theyAskAr: "وين تشوف نفسك بعد خمس سنين؟", correctAr: "على المدى الطويل، هدفي اقود فريق. ناوي اطور مهاراتي القيادية خلال السنتين الجايات.", wrong1Ar: "اريد اكون قائد بعد 5 سنين.", wrong2Ar: "خطتي احصل ترقية.", wrong3Ar: "اتمنى اكون ناجح بعد 5 سنين.", situationRu: "Собеседование на работу", theyAskRu: "Кем вы видите себя через пять лет?", correctRu: "В долгосрочной перспективе моя цель — руководить командой. Я планирую развивать лидерские качества в ближайшие два года.", wrong1Ru: "Я хочу быть лидером через 5 лет.", wrong2Ru: "Мой план — получить повышение.", wrong3Ru: "Надеюсь стать успешным через 5 лет.", explanationRu: "'In the long run... I'm planning to' — очень подходящий и профессиональный ответ на этот вопрос" },
    ],
  },
  ...
  // Lesson 8: Texting & Phone Calls (Casual)
  {
    ...
    fillBlanks: [
      { parts: ["Drop me a", "when you get home safely."], hint: "کاتێک گەیشتیتەوە ماڵەوە بە سەلامەتی نامەیەکم بۆ بنێرە.", answer: "message", wrongs: ["text", "letter", "call"], arabicHint: "دزلي رسالة من توصل للبيت بالسلامة.", arabicParts: ["دزلي", "من توصل للبيت بالسلامة."], arabicAnswer: "رسالة", arabicWrongs: ["مسج", "مكتوب", "مكالمة"], russianHint: "Напиши мне, как благополучно доберешься домой.", russianParts: ["", "мне, как благополучно доберешься домой."], russianAnswer: "Напиши", russianWrongs: ["Позвони", "Черкни", "Сообщи"] },
      { parts: ["My battery is", ", I have to go."], hint: "شەحنی مۆبایلەکەم خەریکە دادەبەزێت، دەبێت بڕۆم.", answer: "dying", wrongs: ["dead", "low", "ending"], arabicHint: "شحني راح يخلص، لازم اروح.", arabicParts: ["شحني راح", "، لازم اروح."], arabicAnswer: "يخلص", arabicWrongs: ["ينزل", "يموت", "ينتهي"], russianHint: "У меня садится батарея, мне пора.", russianParts: ["У меня", "батарея, мне пора."], russianAnswer: "садится", russianWrongs: ["села", "сдохла", "разрядилась"] },
    ],
    conversations: [
      { situation: "قسەکردن لەگەڵ هاوڕێیەک کە کاتی نییە ئێستا قسە بکات", theyAsk: "I'm a bit busy right now, can we talk later?", correct: "Sure! Drop me a message or give me a ring when you're free. I'll text you the details in the meantime.", wrong1: "Sure, call me when you have time.", wrong2: "No problem—we can talk later.", wrong3: "Text me when you're free.", explanation: "'Drop me a message' و 'Give me a ring' زۆر زۆر باون لە زمانی ڕۆژانەی ئینگلیزیدا", situationAr: "تحجي ويه صديق ما عنده وكت هسة", explanationAr: "'Drop me a message' و 'Give me a ring' كلش شائعة بالانكليزية اليومية", theyAskAr: "اني شوية مشغول هسة، نكدر نحجي بعدين؟", correctAr: "اكيد! دزلي رسالة او خابرني من تفرغ. راح ادزلك التفاصيل برسالة بين ما تفرغ.", wrong1Ar: "اكيد، خابرني من يصير عندك وكت.", wrong2Ar: "ماكو مشكلة—نكدر نحجي بعدين.", wrong3Ar: "دزلي مسج من تكون فارغ.", situationRu: "Общение с другом, которому сейчас некогда говорить", theyAskRu: "Я сейчас немного занят, можем поговорить позже?", correctRu: "Конечно! Напиши или звякни мне, когда освободишься. А пока скину тебе подробности.", wrong1Ru: "Конечно, позвони, когда будет время.", wrong2Ru: "Без проблем — поговорим позже.", wrong3Ru: "Напиши, когда освободишься.", explanationRu: "'Drop me a message' и 'Give me a ring' очень часто используются в повседневном английском" },
    ],
  },
