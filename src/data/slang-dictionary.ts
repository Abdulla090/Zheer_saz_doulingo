...
const MODERN_SLANG_AND_IDIOMS_DATA: SlangSeed[] = [
  // Current online and Gen Z language
  makeExpandedSlangItem({ id: "that_tracks", phrase: "That tracks", pronunciation: "زەت تراکس", kuMeaning: "ئەوە لۆژیکییە / لەگەڵ زانیارییەکان دەگونجێت", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "He forgot the meeting again.", speakerB: "That tracks. He's always disorganized.", kuA: "دووبارە کۆبوونەوەکەی لەبیر کرد.", kuB: "ئەوە لۆژیکییە، هەمیشە بێ ڕێکخستنە." }),
  makeExpandedSlangItem({ id: "hard_pass", phrase: "Hard pass", pronunciation: "هارد پاس", kuMeaning: "بە هیچ شێوەیەک ڕازیم نییە / بە تەواوی ڕەتیدەکەمەوە", category: "Slang", context: "Friends & Social", type: "Gen Z Slang", speakerA: "Want to wake up at five for a run?", speakerB: "Hard pass. I need my sleep.", kuA: "دەتەوێت کاتژمێر پێنج هەستین بۆ ڕاکردن؟", kuB: "بە هیچ شێوەیەک، پێویستم بە خەوە." }),
  makeExpandedSlangItem({ id: "here_for_it", phrase: "I'm here for it", pronunciation: "ئایم هیر فۆر ئت", kuMeaning: "زۆرم پێ خۆشە / پشتیوانیم لێ دەکەم", category: "Slang", context: "Friends & Social", type: "Gen Z Slang", speakerA: "Sara started wearing bold colors.", speakerB: "I'm here for it. She looks great.", kuA: "سارا دەستی بە لەبەرکردنی ڕەنگی تۆخ کردووە.", kuB: "زۆرم پێ خۆشە، زۆر جوانە." }),
  makeExpandedSlangItem({ id: "not_gonna_lie", phrase: "Not gonna lie (NGL)", pronunciation: "نات گەنا لای", kuMeaning: "ڕاستییەکەی / بەڕاستی", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "Did you like the movie?", speakerB: "Not gonna lie, the ending was disappointing.", kuA: "فیلمەکەت پێ خۆش بوو؟", kuB: "ڕاستییەکەی، کۆتاییەکەی نائومێدکەر بوو." }),
  makeExpandedSlangItem({ id: "for_real", phrase: "For real (FR)", pronunciation: "فۆر ڕیڵ", kuMeaning: "بەڕاستی / جدی دەڵێم", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "I got the job!", speakerB: "For real? That's amazing!", kuA: "کارەکەم دەست کەوت!", kuB: "بەڕاستی؟ ئەوە زۆر نایابە!" }),
  makeExpandedSlangItem({ id: "be_so_for_real", phrase: "Be so for real", pronunciation: "بی سۆ فۆر ڕیڵ", kuMeaning: "تکایە جدی بە / ئەو قسەیە باوەڕپێکراو نییە", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "I can finish this huge project in ten minutes.", speakerB: "Be so for real. It'll take hours.", kuA: "دەتوانم ئەم پڕۆژە گەورەیە لە دە خولەکدا تەواو بکەم.", kuB: "تکایە جدی بە، چەند کاتژمێرێکی دەوێت." }),
  makeExpandedSlangItem({ id: "period_emphasis", phrase: "Period", pronunciation: "پیریەد", kuMeaning: "قسەکە تەواوە / هیچ مشتومڕێکی تر نییە", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "You deserve to be treated with respect.", speakerB: "Period. I won't accept less.", kuA: "شایستەی ئەوەیت بە ڕێزەوە مامەڵەت لەگەڵ بکرێت.", kuB: "قسەکە تەواوە، کەمتر لەوە قبوڵ ناکەم." }),
  makeExpandedSlangItem({ id: "understood_the_assignment", phrase: "Understood the assignment", pronunciation: "ئەندەرستود زە ئەساینمەنت", kuMeaning: "بە تەواوی زانی چی پێویست بوو و زۆر باشی کرد", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "Her outfit matches the theme perfectly.", speakerB: "She understood the assignment.", kuA: "جلەکانی بە تەواوی لەگەڵ بابەتەکە دەگونجێت.", kuB: "بە تەواوی زانی چی پێویست بوو." }),
  makeExpandedSlangItem({ id: "soft_launch", phrase: "Soft launch", pronunciation: "سۆفت لۆنچ", kuMeaning: "ئاماژەدان بە پەیوەندییەک بەبێ ئاشکراکردنی تەواو", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "Why did she post two coffee cups?", speakerB: "Maybe she's soft-launching a relationship.", kuA: "بۆچی وێنەی دوو کوپی قاوەی بڵاو کردەوە؟", kuB: "لەوانەیە بە ناڕاستەوخۆ ئاماژە بە پەیوەندییەک بکات." }),
  makeExpandedSlangItem({ id: "hard_launch", phrase: "Hard launch", pronunciation: "هارد لۆنچ", kuMeaning: "پەیوەندییەک بە ئاشکرا و فەرمی ڕاگەیاندن", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "They finally posted a photo together.", speakerB: "That's their hard launch.", kuA: "لە کۆتاییدا وێنەیەکی پێکەوەیان بڵاو کردەوە.", kuB: "ئەوە ڕاگەیاندنی ئاشکرای پەیوەندییەکەیانە." }),
  makeExpandedSlangItem({ id: "canon_event", phrase: "Canon event", pronunciation: "کانەن ئیڤێنت", kuMeaning: "ڕووداوێکی گرنگ کە کەسایەتی و ژیانت دەگۆڕێت", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "My first bad haircut taught me a lot.", speakerB: "Honestly, that was a canon event.", kuA: "یەکەم قژبڕینی خراپم زۆر شتی فێر کردم.", kuB: "ڕاستییەکەی، ئەوە ڕووداوێکی گرنگی ژیانت بوو." }),
  makeExpandedSlangItem({ id: "side_quest", phrase: "Side quest", pronunciation: "ساید کوێست", kuMeaning: "کارێکی لاوەکی و چاوەڕواننەکراو لە ناو کارێکی سەرەکیدا", category: "Slang", context: "Daily Life", type: "Gen Z Slang", speakerA: "Why did shopping take three hours?", speakerB: "We went on a side quest for ice cream.", kuA: "بۆچی بازاڕکردن سێ کاتژمێری خایاند؟", kuB: "لە ناو ڕێگا چووین بۆ سۆرەمەنی، بووە کارێکی لاوەکی." }),
  makeExpandedSlangItem({ id: "personal_lore", phrase: "Personal lore", pronunciation: "پێرسناڵ لۆر", kuMeaning: "چیرۆک و ڕووداوەکانی ڕابردووی کەسێک", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "You used to be in a band?", speakerB: "Yeah, that's part of my personal lore.", kuA: "جاران لە گروپێکی مۆسیقادا بوویت؟", kuB: "بەڵێ، ئەوە بەشێکە لە چیرۆکی ڕابردووم." }),
  makeExpandedSlangItem({ id: "show_the_receipts", phrase: "Show the receipts", pronunciation: "شۆ زە ڕیسیتس", kuMeaning: "بەڵگەکە پیشان بدە / قسەکەت بسەلمێنە", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "He says he warned everyone.", speakerB: "Then he should show the receipts.", kuA: "دەڵێت هەموو کەسی ئاگادار کردووەتەوە.", kuB: "کەواتە با بەڵگەکە پیشان بدات." }),
  makeExpandedSlangItem({ id: "ratioed", phrase: "Ratioed", pronunciation: "ڕەیشیۆد", kuMeaning: "وەڵامەکەی زیاتر لە پۆستە سەرەکییەکە پەسەند کرا", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "Why did he delete the post?", speakerB: "He got ratioed in the replies.", kuA: "بۆچی پۆستەکەی سڕییەوە؟", kuB: "وەڵامەکان زیاتر لە پۆستەکەی پەسەند کران." }),
  makeExpandedSlangItem({ id: "left_on_read", phrase: "Left on read", pronunciation: "لێفت ئان ڕید", kuMeaning: "نامەکەت خوێندرایەوە بەڵام وەڵام نەدرایەوە", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "Did Mina answer your message?", speakerB: "No, she left me on read.", kuA: "مینا وەڵامی نامەکەتی دایەوە؟", kuB: "نەخێر، خوێندییەوە بەڵام وەڵامی نەدامەوە." }),
  makeExpandedSlangItem({ id: "slide_into_the_dms", phrase: "Slide into the DMs", pronunciation: "سلاید ئنتو زە دی ئێمز", kuMeaning: "بە نهێنی لە تۆڕی کۆمەڵایەتی نامە بنێرە", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "How did you two start talking?", speakerB: "He slid into my DMs after my post.", kuA: "چۆن دەستتان بە قسەکردن کرد؟", kuB: "دوای پۆستەکەم نامەی تایبەتی بۆ ناردم." }),
  makeExpandedSlangItem({ id: "pov", phrase: "POV", pronunciation: "پی ئۆ ڤی", kuMeaning: "دیدگا / ئەوەی شتێک لە چ دیدێکەوە پیشان دەدرێت", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "What's the caption for your video?", speakerB: "POV: you finally finish your exams.", kuA: "ناونیشانی ڤیدیۆکەت چییە؟", kuB: "دیدگا: لە کۆتاییدا تاقیکردنەوەکانت تەواو دەکەیت." }),
  makeExpandedSlangItem({ id: "fomo", phrase: "FOMO", pronunciation: "فۆمۆ", kuMeaning: "ترسی لەدەستدانی ڕووداو یان ئەزموونێک", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "You look tired. Why are you going out?", speakerB: "Honestly, FOMO. Everyone will be there.", kuA: "ماندوو دیاریت، بۆچی دەچیتە دەرەوە؟", kuB: "ڕاستییەکەی، دەترسم ئەزموونەکە لەدەست بدەم؛ هەمووان لەوێ دەبن." }),
  makeExpandedSlangItem({ id: "icymi", phrase: "ICYMI", pronunciation: "ئای سی وای ئێم ئای", kuMeaning: "ئەگەر لەدەستت چووە / ئەگەر نەتبینیوە", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "Why did you repost the announcement?", speakerB: "ICYMI, registration closes tonight.", kuA: "بۆچی ڕاگەیاندنەکەت دووبارە بڵاو کردەوە؟", kuB: "ئەگەر لەدەستت چووە، تۆمارکردن ئەمشەو دادەخرێت." }),
  makeExpandedSlangItem({ id: "hot_take", phrase: "Hot take", pronunciation: "هات تەیک", kuMeaning: "بۆچوونێکی جێی مشتومڕ یان نائاسایی", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "Here's my hot take: the sequel was better.", speakerB: "I disagree, but I respect it.", kuA: "ئەمە بۆچوونە مشتومڕاوییەکەمە: بەشی دووەم باشتر بوو.", kuB: "ڕازیم نییە، بەڵام ڕێزی لێ دەگرم." }),
  makeExpandedSlangItem({ id: "unhinged", phrase: "Unhinged", pronunciation: "ئەنهینجد", kuMeaning: "زۆر سەیر، کۆنترۆڵنەکراو یان شێتانە", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "Did you see that late-night post?", speakerB: "Yes, it was completely unhinged.", kuA: "ئەو پۆستەی درەنگی شەوت بینی؟", kuB: "بەڵێ، بە تەواوی سەیر و کۆنترۆڵنەکراو بوو." }),
  makeExpandedSlangItem({ id: "youre_sending_me", phrase: "You're sending me", pronunciation: "یۆر سێندینگ می", kuMeaning: "زۆر پێم دەکەنیت / لە پێکەنین نامێنم", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "Look at this old photo of us.", speakerB: "You're sending me! Why was my hair like that?", kuA: "سەیری ئەم وێنە کۆنەمان بکە.", kuB: "لە پێکەنین نامێنم! بۆچی قژم ئاوا بوو؟" }),
  makeExpandedSlangItem({ id: "let_them_cook", phrase: "Let them cook", pronunciation: "لێت زەم کوک", kuMeaning: "با بەردەوام بن؛ لەوانەیە بیرۆکەکەیان باش دەرچێت", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "This idea sounds strange.", speakerB: "Wait—let them cook. It might work.", kuA: "ئەم بیرۆکەیە سەیرە.", kuB: "چاوەڕێ بکە؛ با بەردەوام بێت، لەوانەیە کار بکات." }),
  makeExpandedSlangItem({ id: "aura_farming", phrase: "Aura farming", pronunciation: "ئۆرا فارمینگ", kuMeaning: "بە ئەنقەست کاری کاریگەرانەکردن بۆ زیادکردنی شکۆ و سەرنج", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "Why did he walk away without looking back?", speakerB: "Pure aura farming for the camera.", kuA: "بۆچی بەبێ سەیرکردنەوە ڕۆیشت؟", kuB: "تەنها بۆ کامێرا کاری کاریگەرانەی کرد." }),
  makeExpandedSlangItem({ id: "rage_bait", phrase: "Rage bait", pronunciation: "ڕەیج بەیت", kuMeaning: "ناوەڕۆکێک کە بە ئەنقەست خەڵک توڕە دەکات بۆ سەرنج", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "That opinion can't be serious.", speakerB: "It isn't. The post is rage bait.", kuA: "ئەو بۆچوونە ناکرێت جدی بێت.", kuB: "جدی نییە، پۆستەکە بۆ توڕەکردنی خەڵکە." }),
  makeExpandedSlangItem({ id: "brain_rot", phrase: "Brain rot", pronunciation: "برەین ڕات", kuMeaning: "هەست بە ماندووبوونی مێشک لە زۆر سەیرکردنی ناوەڕۆکی بێسوود", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "You've watched short videos for three hours.", speakerB: "I know. The brain rot is real.", kuA: "سێ کاتژمێرە ڤیدیۆی کورت دەبینیت.", kuB: "دەزانم، مێشکم بەڕاستی ماندوو بووە." }),
  makeExpandedSlangItem({ id: "chronically_online", phrase: "Chronically online", pronunciation: "کرانیکلی ئۆنلاین", kuMeaning: "ئەوەندە زۆر ئۆنلاینە کە لە ژیانی ڕاستەقینە دوور کەوتووەتەوە", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "How do you know every tiny internet argument?", speakerB: "I'm chronically online, unfortunately.", kuA: "چۆن هەموو مشتومڕێکی بچووکی ئینتەرنێت دەزانیت؟", kuB: "بەداخەوە، هەمیشە ئۆنلاینم." }),
  makeExpandedSlangItem({ id: "situationship", phrase: "Situationship", pronunciation: "سیتچوەیشنشیپ", kuMeaning: "پەیوەندییەکی خۆشەویستی کە ناونیشان و سنووری ڕوونی نییە", category: "Slang", context: "Friends & Social", type: "Gen Z Slang", speakerA: "Are you two officially dating?", speakerB: "Not really. It's more of a situationship.", kuA: "ئێوە بە فەرمی پێکەوەن؟", kuB: "نەک بە تەواوی، پەیوەندییەکەمان ڕوون نییە." }),
  makeExpandedSlangItem({ id: "red_flag", phrase: "Red flag", pronunciation: "ڕێد فلاگ", kuMeaning: "نیشانەی ئاگادارکەرەوەی کێشە یان مەترسی", category: "Slang", context: "Friends & Social", type: "Gen Z Slang", speakerA: "He is rude to every waiter.", speakerB: "That's a major red flag.", kuA: "لەگەڵ هەموو گارسۆنێک بە ڕەوشتی خراپە.", kuB: "ئەوە نیشانەیەکی گەورەی ئاگادارکەرەوەیە." }),
  makeExpandedSlangItem({ id: "green_flag", phrase: "Green flag", pronunciation: "گرین فلاگ", kuMeaning: "نیشانەیەکی باش کە کەسێک متمانەپێکراوە", category: "Slang", context: "Friends & Social", type: "Gen Z Slang", speakerA: "She listens and respects boundaries.", speakerB: "Definitely a green flag.", kuA: "گوێ دەگرێت و ڕێز لە سنوورەکان دەگرێت.", kuB: "بە دڵنیاییەوە نیشانەیەکی باشە." }),
  makeExpandedSlangItem({ id: "dry_texting", phrase: "Dry texting", pronunciation: "درای تکستینگ", kuMeaning: "وەڵامدانەوەی زۆر کورت و بێ هەست لە نامەدا", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "He only replies with 'okay.'", speakerB: "That dry texting makes conversation hard.", kuA: "تەنها بە «باشە» وەڵام دەداتەوە.", kuB: "ئەو وەڵامە کورت و بێ هەستانە قسەکردن قورس دەکات." }),
  makeExpandedSlangItem({ id: "face_card", phrase: "Face card", pronunciation: "فەیس کارد", kuMeaning: "جوانی ڕووخسار کە هەمیشە سەرنجڕاکێشە", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "She looks amazing in every photo.", speakerB: "Her face card never declines.", kuA: "لە هەموو وێنەیەکدا زۆر جوانە.", kuB: "جوانی ڕووخساری هەمیشە سەرنجڕاکێشە." }),
  makeExpandedSlangItem({ id: "serving", phrase: "Serving", pronunciation: "سێرڤینگ", kuMeaning: "زۆر جوان و بەهێز پیشاندانی ستایل یان هەڵوێست", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "What do you think of this outfit?", speakerB: "You're serving. Keep it exactly like that.", kuA: "ڕات چییە لەسەر ئەم جلوبەرگە؟", kuB: "زۆر سەرنجڕاکێشیت، هەر ئاوا بیهێڵەوە." }),
  makeExpandedSlangItem({ id: "clocked_it", phrase: "Clocked it", pronunciation: "کلاکت ئت", kuMeaning: "بە دروستی تێگەیشت یان شتێکی نهێنی زانی", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "I knew the surprise was for me.", speakerB: "You clocked it immediately.", kuA: "دەستم کەوتبوو کە سەرسوڕمانەکە بۆ منە.", kuB: "دەستبەجێ بە دروستی تێگەیشتیت." }),
  makeExpandedSlangItem({ id: "doomscrolling", phrase: "Doomscrolling", pronunciation: "دووم سکرۆڵینگ", kuMeaning: "بەردەوام سکرۆڵکردنی هەواڵ و ناوەڕۆکی خراپ", category: "Slang", context: "Online & Gen Z", type: "Gen Z Slang", speakerA: "Why are you still awake?", speakerB: "I got stuck doomscrolling the news.", kuA: "بۆچی هێشتا بەئاگایت؟", kuB: "گیرسامەوە بە سکرۆڵکردنی بەردەوامی هەواڵە خراپەکان." }),

  // Common modern idioms used in everyday conversation
  makeExpandedSlangItem({ id: "call_it_quits", phrase: "Call it quits", pronunciation: "کۆڵ ئت کویتس", kuMeaning: "واز لە کارێک بهێنە یان کۆتایی پێبهێنە", category: "Idioms", context: "Daily Life", type: "Idiom", speakerA: "We've been working for ten hours.", speakerB: "Let's call it quits for today.", kuA: "دە کاتژمێرە کار دەکەین.", kuB: "با بۆ ئەمڕۆ کۆتایی پێبهێنین." }),
  makeExpandedSlangItem({ id: "cut_to_the_chase", phrase: "Cut to the chase", pronunciation: "کەت تو زە چەیس", kuMeaning: "ڕاستەوخۆ بچۆ سەر بابەتی سەرەکی", category: "Idioms", context: "Work & Business", type: "Idiom", speakerA: "I know there's a long story.", speakerB: "I'll cut to the chase: we got the contract.", kuA: "دەزانم چیرۆکەکە درێژە.", kuB: "ڕاستەوخۆ دەچمە سەر بابەتەکە: گرێبەستەکەمان بەدەست هێنا." }),
  makeExpandedSlangItem({ id: "get_your_act_together", phrase: "Get your act together", pronunciation: "گێت یۆر ئەکت تەگێزەر", kuMeaning: "خۆت ڕێکبخە و بە بەرپرسیارییەوە کار بکە", category: "Idioms", context: "Daily Life", type: "Idiom", speakerA: "I missed another deadline.", speakerB: "You need to get your act together.", kuA: "دووبارە دوا کەوتم لە کاتی دیاریکراو.", kuB: "پێویستە خۆت ڕێکبخەیت." }),
  makeExpandedSlangItem({ id: "read_the_room", phrase: "Read the room", pronunciation: "ڕید زە ڕووم", kuMeaning: "هەست و بارودۆخی خەڵکی دەوروبەر تێبگە", category: "Idioms", context: "Friends & Social", type: "Idiom", speakerA: "Why did everyone go quiet after his joke?", speakerB: "He really needs to read the room.", kuA: "بۆچی هەمووان دوای گاڵتەکەی بێدەنگ بوون؟", kuB: "پێویستە بارودۆخی خەڵک تێبگات." }),
  makeExpandedSlangItem({ id: "on_thin_ice", phrase: "On thin ice", pronunciation: "ئان ثین ئایس", kuMeaning: "لە دۆخێکی مەترسیداردا بیت و هەڵەیەکی تر کێشە دروست بکات", category: "Idioms", context: "Work & Business", type: "Idiom", speakerA: "Can I be late again tomorrow?", speakerB: "You're already on thin ice with the manager.", kuA: "دەتوانم سبەی دووبارە دوا بکەوم؟", kuB: "هەر ئێستا لەلایەن بەڕێوەبەرەوە دۆخت مەترسیدارە." }),
  makeExpandedSlangItem({ id: "throw_under_the_bus", phrase: "Throw someone under the bus", pronunciation: "ثرۆ سەموان ئەندەر زە بەس", kuMeaning: "بۆ پاراستنی خۆت تاوان بخەیتە ئەستۆی کەسێکی تر", category: "Idioms", context: "Work & Business", type: "Idiom", speakerA: "Why did he blame you for the mistake?", speakerB: "He threw me under the bus to protect himself.", kuA: "بۆچی تۆی بە هۆکاری هەڵەکە دانا؟", kuB: "بۆ پاراستنی خۆی تاوانەکەی خستە ئەستۆی من." }),
  makeExpandedSlangItem({ id: "go_with_the_flow", phrase: "Go with the flow", pronunciation: "گۆ وذ زە فلۆ", kuMeaning: "بەبێ نیگەرانی لەگەڵ بارودۆخەکە بڕۆ", category: "Idioms", context: "Daily Life", type: "Idiom", speakerA: "We don't have a plan for the weekend.", speakerB: "That's okay. Let's go with the flow.", kuA: "بۆ کۆتایی هەفتە پلانمان نییە.", kuB: "کێشە نییە، با لەگەڵ بارودۆخەکە بڕۆین." }),
  makeExpandedSlangItem({ id: "a_long_shot", phrase: "A long shot", pronunciation: "ئە لۆنگ شات", kuMeaning: "هەوڵێک کە ئەگەری سەرکەوتنی زۆر کەمە", category: "Idioms", context: "Daily Life", type: "Idiom", speakerA: "Do you think we'll get front-row tickets?", speakerB: "It's a long shot, but we can try.", kuA: "پێتوایە بلیتی ڕیزی یەکەممان دەست بکەوێت؟", kuB: "ئەگەری کەمە، بەڵام دەتوانین هەوڵ بدەین." }),
  makeExpandedSlangItem({ id: "back_on_track", phrase: "Back on track", pronunciation: "باک ئان تراک", kuMeaning: "گەڕانەوە بۆ ڕێڕەوی دروست و پێشکەوتن", category: "Idioms", context: "Work & Business", type: "Idiom", speakerA: "Is the project still delayed?", speakerB: "No, we're back on track now.", kuA: "پڕۆژەکە هێشتا دوا کەوتووە؟", kuB: "نەخێر، ئێستا گەڕاوینەتەوە سەر ڕێڕەوی دروست." }),
  makeExpandedSlangItem({ id: "the_last_straw", phrase: "The last straw", pronunciation: "زە لاست سترۆ", kuMeaning: "دوا شت کە ئارامت لێ دەبڕێت", category: "Idioms", context: "Daily Life", type: "Idiom", speakerA: "Why did you finally complain?", speakerB: "The third canceled appointment was the last straw.", kuA: "بۆچی لە کۆتاییدا سکاڵات کرد؟", kuB: "هەڵوەشاندنەوەی سێیەم دوا شت بوو کە ئارامی لێ بڕیم." }),
  makeExpandedSlangItem({ id: "dodged_a_bullet", phrase: "Dodged a bullet", pronunciation: "داجد ئە بوڵت", kuMeaning: "لە کێشە یان مەترسییەکی گەورە ڕزگار بوو", category: "Idioms", context: "Daily Life", type: "Idiom", speakerA: "That company closed right after rejecting me.", speakerB: "Looks like you dodged a bullet.", kuA: "ئەو کۆمپانیایە ڕاست دوای ڕەتکردنەوەم داخرا.", kuB: "وادیارە لە کێشەیەکی گەورە ڕزگارت بوو." }),
  makeExpandedSlangItem({ id: "burned_out", phrase: "Burned out", pronunciation: "بێرند ئاوت", kuMeaning: "لەبەر کاری زۆر بە تەواوی ماندووی جەستەیی و دەروونی بوون", category: "Idioms", context: "Work & Business", type: "Everyday Phrase", speakerA: "Why are you taking a week off?", speakerB: "I'm burned out and need to rest.", kuA: "بۆچی هەفتەیەک مۆڵەت وەردەگریت؟", kuB: "لە کاری زۆر بە تەواوی ماندووم و پێویستم بە پشووە." }),
  makeExpandedSlangItem({ id: "in_the_loop", phrase: "In the loop", pronunciation: "ئن زە لووپ", kuMeaning: "لە نوێترین زانیاری و بڕیارەکان ئاگادار بیت", category: "Idioms", context: "Work & Business", type: "Idiom", speakerA: "Does Noor know about the changes?", speakerB: "Yes, I've kept her in the loop.", kuA: "نوور لە گۆڕانکارییەکان ئاگادارە؟", kuB: "بەڵێ، لە هەموو زانیارییەکان ئاگادارم کردووەتەوە." }),
  makeExpandedSlangItem({ id: "out_of_the_loop", phrase: "Out of the loop", pronunciation: "ئاوت ئەڤ زە لووپ", kuMeaning: "لە نوێترین زانیاری و ڕووداوەکان بێئاگا بیت", category: "Idioms", context: "Work & Business", type: "Idiom", speakerA: "When did the deadline change?", speakerB: "I don't know. I'm completely out of the loop.", kuA: "کەی کاتی دوا گۆڕا؟", kuB: "نازانم، بە تەواوی لە زانیارییەکان بێئاگام." }),
  makeExpandedSlangItem({ id: "break_the_ice", phrase: "Break the ice", pronunciation: "برەیک زە ئایس", kuMeaning: "دەستپێکردنی قسە بۆ کەمکردنەوەی شەرم و ناڕەحەتی", category: "Idioms", context: "Friends & Social", type: "Idiom", speakerA: "The group was very quiet.", speakerB: "I told a joke to break the ice.", kuA: "گروپەکە زۆر بێدەنگ بوو.", kuB: "گاڵتەیەکم کرد بۆ ئەوەی قسە دەست پێ بکات." }),
  makeExpandedSlangItem({ id: "worth_a_shot", phrase: "Worth a shot", pronunciation: "وێرث ئە شات", kuMeaning: "شایستەی تاقیکردنەوەیە هەرچەند دڵنیایی نییە", category: "Idioms", context: "Daily Life", type: "Idiom", speakerA: "Do you think they'll accept a late application?", speakerB: "Maybe not, but it's worth a shot.", kuA: "پێتوایە داواکارییەکی دواخراو قبوڵ بکەن؟", kuB: "لەوانەیە نا، بەڵام شایستەی هەوڵدانە." }),
  makeExpandedSlangItem({ id: "sleep_on_it", phrase: "Sleep on it", pronunciation: "سلیپ ئان ئت", kuMeaning: "پێش بڕیاردان شەوێک بیر لە شتەکە بکەوە", category: "Idioms", context: "Daily Life", type: "Idiom", speakerA: "Should I accept the offer now?", speakerB: "Sleep on it and decide tomorrow.", kuA: "ئێستا پێشنیارەکە قبوڵ بکەم؟", kuB: "شەوێک بیری لێ بکەوە و سبەی بڕیار بدە." }),
  makeExpandedSlangItem({ id: "run_out_of_steam", phrase: "Run out of steam", pronunciation: "ڕەن ئاوت ئەڤ ستیم", kuMeaning: "وزە و هاندانت نامێنێت", category: "Idioms", context: "Daily Life", type: "Idiom", speakerA: "Why did you stop cleaning?", speakerB: "I ran out of steam after the kitchen.", kuA: "بۆچی وازت لە پاککردنەوە هێنا؟", kuB: "دوای چێشتخانەکە وزەم نەما." }),
  makeExpandedSlangItem({ id: "bite_off_more_than_you_can_chew", phrase: "Bite off more than you can chew", pronunciation: "بایت ئۆف مۆر زەن یو کەن چوو", kuMeaning: "کاری زیاتر لە توانای خۆت لە ئەستۆ بگریت", category: "Idioms", context: "Work & Business", type: "Idiom", speakerA: "I accepted five projects at once.", speakerB: "You may have bitten off more than you can chew.", kuA: "پێنج پڕۆژەم یەکجار قبوڵ کرد.", kuB: "لەوانەیە کاری زیاتر لە توانای خۆت لە ئەستۆ گرتبێت." }),
  makeExpandedSlangItem({ id: "read_between_the_lines", phrase: "Read between the lines", pronunciation: "ڕید بتوین زە لاینز", kuMeaning: "مانای نادیار و ناڕاستەوخۆی قسەکە تێبگە", category: "Idioms", context: "Daily Life", type: "Idiom", speakerA: "She said the meeting was 'interesting.'", speakerB: "Read between the lines—she didn't like it.", kuA: "گوتی کۆبوونەوەکە «سەرنجڕاکێش» بوو.", kuB: "مانای نادیارەکەی تێبگە؛ پێی خۆش نەبوو." }),
  makeExpandedSlangItem({ id: "on_the_fence", phrase: "On the fence", pronunciation: "ئان زە فێنس", kuMeaning: "هێشتا بڕیارت نەداوە و دوودڵیت", category: "Idioms", context: "Daily Life", type: "Idiom", speakerA: "Are you joining the trip?", speakerB: "I'm still on the fence.", kuA: "بەشداری گەشتەکە دەکەیت؟", kuB: "هێشتا دوودڵم و بڕیارم نەداوە." }),
  makeExpandedSlangItem({ id: "out_of_the_blue", phrase: "Out of the blue", pronunciation: "ئاوت ئەڤ زە بلوو", kuMeaning: "بە لەناکاو و بێ هیچ پێشەکییەک", category: "Idioms", context: "Daily Life", type: "Idiom", speakerA: "When did he call you?", speakerB: "Out of the blue, after two years.", kuA: "کەی تەلەفۆنی بۆ کردیت؟", kuB: "بە لەناکاو، دوای دوو ساڵ." }),
];
...
const normalizedSlangPhrases = new Set<string>();
for (const item of [
  ...BASE_SLANG_DATA,
  ...EXPANDED_SLANG_DATA,
  ...
  ...MODERN_SLANG_AND_IDIOMS_DATA,
]) {
  const normalizedPhrase = item.phrase.trim().toLocaleLowerCase("en-US");
  if (!uniqueSlangSeeds.has(item.id) && !normalizedSlangPhrases.has(normalizedPhrase)) {
    uniqueSlangSeeds.set(item.id, item);
    normalizedSlangPhrases.add(normalizedPhrase);
  }
}
