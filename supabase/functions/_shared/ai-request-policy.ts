...
export const AI_REQUEST_POLICIES = {
  ...
  roleplay_text_response: { model: "gemini-3.5-flash-lite", maxOutputTokens: 512, responseMimeType: "application/json" },
  roleplay_voice_response: { model: "gemini-3.6-flash", maxOutputTokens: 640, responseMimeType: "application/json" },
  study_tutor: { model: "gemini-3.6-flash", maxOutputTokens: 4096, responseMimeType: "application/json" },
} as const;
