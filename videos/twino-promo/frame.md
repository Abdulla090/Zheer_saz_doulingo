...
description: >
  ...
  accent, the three-step gray text ladder, DIN Next Rounded (display/numerals/chrome) + DIN Next Rounded (body),
...
colors:
  ...
  text-muted: "#6B6B6B"
  text-light: "#9A9A9A"
  accent-light: "rgba(255, 200, 0, 0.08)"
  accent-medium: "rgba(255, 200, 0, 0.15)"
  border: "rgba(255, 200, 0, 0.2)"
  card-bg: "rgba(255, 200, 0, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  # — reading ramp (DIN Next Rounded body + DIN Next Rounded chrome) —
  body:    { fontFamily: "DIN Next Rounded", cqw: 0.85, weight: 400, lineHeight: 1.6, color: "text-muted" }
  h4-eyebrow:{ fontFamily: "DIN Next Rounded", cqw: 0.8, weight: 600, tracking: "0.08em", upper: true, color: "primary" }
  tag:     { fontFamily: "DIN Next Rounded", px: 12, weight: 500, color: "primary" }
  counter: { fontFamily: "DIN Next Rounded", px: 13, weight: 500, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (DIN Next Rounded, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "DIN Next Rounded", cqw: 1.25, weight: 500, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "DIN Next Rounded", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "DIN Next Rounded", cqw: 2.4, weight: 500, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "DIN Next Rounded", cqw: 2.6, weight: 600, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
  metric-value:{ fontFamily: "DIN Next Rounded", cqw: 3.0, weight: 700, lineHeight: 1.0, color: "primary" }
  h1:      { fontFamily: "DIN Next Rounded", cqw: 4.2, weight: 700, lineHeight: 1.08, tracking: "-0.02em", color: "text" }
  quote-mark:{ fontFamily: "DIN Next Rounded", cqw: 8.0, weight: 700, lineHeight: 0.5, color: "primary", opacity: 0.15 }
...
components:
  ...
  cta-button:
    ...
    textColor: "{colors.bg}"
    rounded: "{radii.pill}"
    typography: "DIN Next Rounded 600"
...
- **Fonts** — already set to **DIN Next Rounded** (display) / **Inter** (body); ignore any preset font name lingering in prose.
...
The voice is two faces in fixed roles: **DIN Next Rounded** (display, every numeral, all chrome —
eyebrows uppercase 0.08em) and **DIN Next Rounded** (body, muted gray, line 1.6). Headlines are near-black;
...
- **DIN Next Rounded** (display/numerals/chrome) + **DIN Next Rounded** (body) — near-black headlines, cobalt numerals.
...
Two ramps. The **reading ramp** (DIN Next Rounded body 0.85cqw muted; DIN Next Rounded eyebrow uppercase 0.08em
cobalt) carries copy + chrome; the **display/numerical ramp** (DIN Next Rounded `h3` 1.25cqw → `h1`
...
- **Headlines near-black, −0.02em**; **eyebrows cobalt, uppercase, 0.08em**; **numerals cobalt 600–700**; **body DIN Next Rounded 400 muted, line 1.6**. No italic, no uppercase body, no cobalt headline.
...
**Composes** accent-line, meta, h1, body sub. **Focal** a 2-line DIN Next Rounded `h1` near-black, left,
...
**Focal** a row of tinted cards — cobalt `metric-value` + DIN Next Rounded label + muted desc + optional
...
blockquote, cite. **Focal** a DIN Next Rounded `blockquote` near-black under a 15%-opacity cobalt
...
DIN Next Rounded body column beside a cobalt-8% highlight block (4px cobalt left rule) carrying an inline pull
...
a DIN Next Rounded `h1` near-black, centered, with the one solid cobalt `cta-button` pill below. **Accent**
...
- Use **tinted cards** (4% fill, 20% border, 10–14px radius, no shadow); body DIN Next Rounded 400 muted, line 1.6.
...
- **Type** — DIN Next Rounded headings −0.02em near-black, cobalt eyebrows 0.08em + numerals; DIN Next Rounded body muted line 1.6; ≥1.4cqw floor.
...
- **DIN Next Rounded + DIN Next Rounded via Google Fonts.** CJK pairing (Noto Sans SC 700 display / Noto Serif SC 400 body) carries over; the eyebrow's uppercase+tracking signal weakens in CJK — pair it with the accent-line.
